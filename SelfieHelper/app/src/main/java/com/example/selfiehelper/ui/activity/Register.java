...
import com.example.selfiehelper.ui.activity.LoginActivity;
                    ...
                    mAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if(task.isSuccessful()){
                                ...
                                mDialog.dismiss();
                                Toast.makeText(Register.this,"Registered Successfully, Please check email for varification",Toast.LENGTH_SHORT).show();
                                email.setText("");
                                password.setText("");
                            }
                            else{
