...
public class HotspotGroupChat extends AppCompatActivity implements GroupCreationDialog.GroupCreationAcceptButtonListener {


    private static final String TAG = HotspotGroupChat.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCreateGroup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                groupCreationDialog.addGroupCreationAcceptListener(HotspotGroupChat.this);
    ...
    private void searchAvailableGroups() {
        final ProgressDialog progressDialog = new ProgressDialog(HotspotGroupChat.this);
