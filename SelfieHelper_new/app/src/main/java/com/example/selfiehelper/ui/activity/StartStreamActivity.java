...
import com.example.selfiehelper.adapter.StartStreamPagerAdapter;
import com.example.selfiehelper.presenter.StartStreamPresenter;
...
import com.example.selfiehelper.view.StartStreamView;
...
public class StartStreamActivity extends TiActivity<StartStreamPresenter, StartStreamView> implements StartStreamView,
    ...
    public static final int PAGE_GroupJoin = 2;
    ...
    public void SlideToGroupCreatePage() {
        viewPager.setCurrentItem(PAGE_GroupJoin);
    }
