...
import com.example.selfiehelper.presenter.GroupCreationDialog;
import com.example.selfiehelper.ui.activity.GroupChatActivity;

import java.util.ArrayList;
import java.util.List;

public class GroupCreateFragment extends AppCompatActivity implements GroupCreationDialog.GroupCreationAcceptButtonListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_Connect_Group);

        wiFiDirectBroadcastReceiver = WiFiP2PInstance.getInstance(this).getBroadcastReceiver();


        Button btnCreateGroup = (Button) findViewById(R.id.btn_createGroup);

        btnCreateGroup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                groupCreationDialog = new GroupCreationDialog();
                groupCreationDialog.addGroupCreationAcceptListener(GroupCreateFragment.this);
    ...
    private void searchAvailableGroups() {
        final ProgressDialog progressDialog = new ProgressDialog(GroupCreateFragment.this);
